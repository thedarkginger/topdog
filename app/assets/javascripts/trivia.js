...
// var files_xml = {'General':'general.xml', 'Animals':'animals.xml'};

   /* IF YOU WANT TO USE JSON FORMAT */
// DELETE the line 341 (above), and delete also the three slashes added at the last line (350)

// Here add pairs with "Category_name" and the file with JSON with quizzes associated to each category
